...
## Consolidated Master Quiz Bank & Exam Review (Quizzes 1–5)
**Department of Computer Science, University of Ghana**  
**Course Code:** DCIT 418 | **Credits:** 3 Credits  
**Prepared by:** Ryan Brown  
**Source / Links Provided by:** Bayat, Eugene, Christian, Ryan, and Sakai Question Pools  
**Source Format / Reference:** Consolidated Sakai Quiz Bank, Exam Takes, and Chat Exports  

---

### 📝 Study Checklist & Progress Tracker
- [ ] **Part 1: Quiz 1 — IT Security Policy Framework & Infrastructure Domains (99 Unique Questions)**
  - [ ] Core Exam Takes (Q1–Q30)
  - [ ] Extended Sakai Question Pool (Q31–Q99)
- [ ] **Part 2: Quiz 2 — Internet of Things (IoT), Mobile IP, BYOD & Emerging Technologies (35 Unique Questions)**
  - [ ] Core Exam Takes (Q1–Q33)
  - [ ] Extended Sakai Question Pool (Q34–Q35)
- [ ] **Part 3: Quiz 3 — Comprehensive Question Bank & Review (All Test Takes & Eugene's Chat Export) (75 Unique Questions)**
  - [ ] Core Exam Takes (Q1–Q68)
  - [ ] Extended Sakai Question Pool (Q69–Q75)
- [ ] **Part 4: Quiz 4 — Cryptography & Block Cipher Modes (Bayat's Take - 68 Questions) (68 Unique Questions)**
  - [ ] Core Exam Takes (Q1–Q68)
- [ ] **Part 5: Quiz 5 — Comprehensive Question Bank & Review (Bayat's Take - 70 Questions) (90 Unique Questions)**
  - [ ] Core Exam Takes (Q1–Q70)
  - [ ] Extended Sakai Question Pool (Q71–Q90)
...
> **Prepared by:** Ryan Brown  
> **Source / Links Provided by:** Bayat, Eugene, Christian, Ryan, and Sakai Question Pools  
> This master document consolidates all **367 verified unique quiz questions** across DCIT 418: Quizzes 1 through 5. All duplicate questions (both intra-quiz formatting duplicates and cross-quiz review items) have been thoroughly deduplicated and indexed.
> - For repeated exam questions, occurrence counts (`2x`, `3x`) and source takes are tracked in each module's **Question Frequency & Repetition Analysis Table**.
> - High-density **Answer Summary Tables** (12-column grid format) provide rapid reference for each quiz.
> - Every question features an interactive **'Reveal Answer'** drop-down containing verified answers and detailed conceptual/engineering intuition based on course literature and William Stallings' *Cryptography and Network Security*.

---

## 📑 Master Quiz Index & Syllabus Coverage

| Part | Quiz Title | Syllabus Scope & Topics | Unique Questions |
|:---:|:---|:---|:---:|
| **Quiz 1** | [IT Security Policy Framework & Infrastructure Domains](#quiz-1-it-security-policy-framework--infrastructure-domains) | Policies, Standards, 7 Domains, CIA Triad, MTTF, SOX, GLBA | **99** |
| **Quiz 2** | [Internet of Things (IoT), Mobile IP & BYOD](#quiz-2-internet-of-things-iot-mobile-ip-byod--emerging-technologies) | Smart Cities, Telemetry, Metadata, Mobile IP (HA/FA/MN), BYOD | **35** |
| **Quiz 3** | [Data Protection, DPIA & African Data Sovereignty](#quiz-3-data-protection-dpia--african-data-sovereignty) | DPIA, Data Localization, POPIA, NDPA, Malabo Convention, 72h Breach | **75** |
| **Quiz 4** | [Cryptography & Block Cipher Modes](#quiz-4-cryptography--block-cipher-modes) | DES, 3DES, AES, Modes (ECB, CBC, CFB, CTR), Number Theory, RSA, ECC | **68** |
| **Quiz 5** | [Hashes, MACs, Digital Signatures, PKI & Protocols](#quiz-5-hashes-macs-digital-signatures-pki--network-security-protocols) | SHA-1/2/3, HMAC, DSA, X.509, Kerberos, IPsec, TLS, 802.11i, PGP | **90** |
| **Total** | **All 5 Quizzes Consolidated** | **Full DCIT 418 Systems and Network Security Curriculum** | **367** |

---

## Quiz 1: IT Security Policy Framework & Infrastructure Domains
**Topic:** IT Security Policy Framework, 7 IT Infrastructure Domains, Security Regulations & CIA Triad  
**Total Questions:** 99 (Core Exam Takes: 30, Extended Sakai Pool: 69)

### Quiz 1 Complete Answer Summary Table

| Q | Answer | Q | Answer | Q | Answer | Q | Answer | Q | Answer | Q | Answer |
|---|--------|---|--------|---|--------|---|--------|---|--------|---|--------|
| **1** | B | **18** | D | **35** | C | **52** | B | **69** | B | **86** | C |
| **2** | B | **19** | A | **36** | C | **53** | C | **70** | C | **87** | C |
| **3** | A | **20** | B | **37** | A | **54** | A | **71** | B | **88** | C |
| **4** | A | **21** | A | **38** | C | **55** | B | **72** | B | **89** | B |
| **5** | C | **22** | A | **39** | B | **56** | C | **73** | B | **90** | B |
| **6** | A | **23** | D | **40** | C | **57** | C | **74** | C | **91** | B |
| **7** | D | **24** | A | **41** | B | **58** | B | **75** | B | **92** | A |
| **8** | B | **25** | A | **42** | C | **59** | B | **76** | B | **93** | C |
| **9** | C | **26** | A | **43** | B | **60** | C | **77** | A | **94** | A |
| **10** | A | **27** | A | **44** | B | **61** | A | **78** | B | **95** | B |
| **11** | B | **28** | A | **45** | C | **62** | B | **79** | B | **96** | A |
| **12** | A | **29** | A | **46** | B | **63** | A | **80** | B | **97** | C |
| **13** | A | **30** | B | **47** | C | **64** | B | **81** | B | **98** | A |
| **14** | A | **31** | B | **48** | C | **65** | A | **82** | C | **99** | A |
| **15** | A | **32** | A | **49** | A | **66** | B | **83** | B |  |  |
| **16** | B | **33** | C | **50** | C | **67** | C | **84** | B |  |  |
| **17** | A | **34** | B | **51** | D | **68** | B | **85** | A |  |  |

---

### 📊 Quiz 1 Question Frequency & Repetition Analysis Table

| Q# | Question Topic / Core Concept | Answer | Repetition Count | Test Occurrences / Source Takes |
|:---|:------------------------------|:------:|:----------------:|:--------------------------------|
| **1** | Written definitions for hardware/software standards | B | **1x** | Main Take (Q1) |
| **2** | Sarbanes-Oxley Act (SOX) coverage & financial privacy | B | **1x** | Main Take (Q2), Bayat's Quiz 1 Take (Q5) |
| **3** | Definition of User Domain (people & processes) | A | **1x** | Main Take (Q3) |
| **4** | Data classification standard definition & framework | A | **1x** | Main Take (Q4), Bayat's Quiz 1 Take (Q6) |
| **5** | Element offering recommendations (Guidelines) | C | **1x** | Main Take (Q5) |
| **6** | Hypertext Transfer Protocol (HTTP) cleartext payload | A | **1x** | Main Take (Q6), Bayat's Quiz 1 Take (Q4) |
| **7** | Applicable financial regulation for compliance (GLBA) | D | **1x** | Main Take (Q7), Bayat's Quiz 1 Take (Q3) |
| **8** | Definition of Information System vs Risk Countermeasure | B | **1x** | Main Take (Q8) |
| **9** | Brute-force attack & mobile worker laptop domain | C | **1x** | Main Take (Q9), Bayat's Quiz 1 Take (Q7) |
| **10** | Definition of Risk (likelihood of impact) | A | **2x** | Main Take (Q10), Quiz 3 Take (Q63) |
| **11** | Device for active malicious connection blocking (IPS) | B | **1x** | Main Take (Q11) |
| **12** | Primary risk across Workstation, LAN & App domains | A | **1x** | Main Take (Q12) |
| **13** | Eavesdropping defense on WAN (Encryption) | A | **1x** | Main Take (Q13) |
| **14** | Tenet dealing with uptime & downtime (Availability) | A | **1x** | Main Take (Q14) |
| **15** | LAN Domain physical & logical components | A | **1x** | Main Take (Q15) |
| **16** | Policy defining data classification & asset priorities | B | **1x** | Main Take (Q16) |
| **17** | SLAs as a component of LAN-to-WAN Domain | A | **1x** | Main Take (Q17), Bayat's Quiz 1 Take (Q1) |
| **18** | Data center access & server downtime domain | D | **2x** | Main Take (Q18), Quiz 3 Take (Q60) |
| **19** | Executive approval framework element (Policy) | A | **2x** | Main Take (Q19), Sakai Question Pool |
| **20** | Metric for average time between failures (MTTF) | B | **1x** | Main Take (Q20), Bayat's Quiz 1 Take (Q2) |
| **21** | Security policy framework as blueprint/outline | A | **1x** | Main Take (Q21) |
| **22** | Continuous monitoring requirement for WAN equipment | A | **1x** | Main Take (Q22) |
| **23** | Mandatory step-by-step update instructions (Procedure) | D | **1x** | Main Take (Q23) |
| **24** | First layer of defense in defense-in-depth (User Domain) | A | **1x** | Main Take (Q24), Bayat's Quiz 1 Take (Q8) |
| **25** | Definition of Authorization (granting rights) | A | **1x** | Main Take (Q25) |
| **26** | Definition of Cryptography (unreadable data) | A | **2x** | Main Take (Q26), Quiz 3 Take (Q64) |
| **27** | Database & storage encryption benefit (Defense-in-depth) | A | **1x** | Main Take (Q27) |
| **28** | LAN-to-WAN Domain linking internal LAN to WAN/Internet | A | **1x** | Main Take (Q28) |
| **29** | Compliance data classification categories | A | **1x** | Main Take (Q29) |
| **30** | HTTP encryption capability (False) | B | **1x** | Main Take (Q30) |
| **31** | CIA Triad | B | **1x** | Extended Sakai Question Pool |
| **32** | CIA Triad | A | **1x** | Extended Sakai Question Pool |
| **33** | CIA Triad | C | **1x** | Extended Sakai Question Pool |
| **34** | CIA Triad | B | **1x** | Extended Sakai Question Pool |
| **35** | CIA Triad | C | **1x** | Extended Sakai Question Pool |
| **36** | Access Control | C | **1x** | Extended Sakai Question Pool |
| **37** | Access Control | A | **1x** | Extended Sakai Question Pool |
| **38** | Access Control | C | **1x** | Extended Sakai Question Pool |
| **39** | Access Control | B | **1x** | Extended Sakai Question Pool |
| **40** | Access Control | C | **1x** | Extended Sakai Question Pool |
| **41** | Access Control | B | **1x** | Extended Sakai Question Pool |
| **42** | Access Control | C | **1x** | Extended Sakai Question Pool |
| **43** | Seven Domains | B | **1x** | Extended Sakai Question Pool |
| **44** | Seven Domains | B | **1x** | Extended Sakai Question Pool |
| **45** | Seven Domains | C | **1x** | Extended Sakai Question Pool |
| **46** | Seven Domains | B | **1x** | Extended Sakai Question Pool |
| **47** | Seven Domains | C | **1x** | Extended Sakai Question Pool |
| **48** | Seven Domains | C | **1x** | Extended Sakai Question Pool |
| **49** | Security Policy Framework | A | **1x** | Extended Sakai Question Pool |
| **50** | Security Policy Framework | C | **1x** | Extended Sakai Question Pool |
| **51** | Security Policy Framework | D | **1x** | Extended Sakai Question Pool |
| **52** | Security Policy Framework | B | **1x** | Extended Sakai Question Pool |
| **53** | Risk Management | C | **1x** | Extended Sakai Question Pool |
| **54** | Risk Management | A | **1x** | Extended Sakai Question Pool |
| **55** | Risk Management | B | **1x** | Extended Sakai Question Pool |
| **56** | Risk Management | C | **1x** | Extended Sakai Question Pool |
| **57** | Risk Management | C | **1x** | Extended Sakai Question Pool |
| **58** | Risk Management | B | **1x** | Extended Sakai Question Pool |
| **59** | Compliance | B | **1x** | Extended Sakai Question Pool |
| **60** | Compliance | C | **1x** | Extended Sakai Question Pool |
| **61** | Compliance | A | **1x** | Extended Sakai Question Pool |
| **62** | Compliance | B | **1x** | Extended Sakai Question Pool |
| **63** | Compliance | A | **1x** | Extended Sakai Question Pool |
| **64** | Compliance | B | **1x** | Extended Sakai Question Pool |
| **65** | Compliance | A | **1x** | Extended Sakai Question Pool |
| **66** | Protocols and Ports | B | **1x** | Extended Sakai Question Pool |
| **67** | Protocols and Ports | C | **1x** | Extended Sakai Question Pool |
| **68** | Protocols and Ports | B | **1x** | Extended Sakai Question Pool |
| **69** | Protocols and Ports | B | **1x** | Extended Sakai Question Pool |
| **70** | Protocols and Ports | C | **1x** | Extended Sakai Question Pool |
| **71** | Protocols and Ports | B | **1x** | Extended Sakai Question Pool |
| **72** | Protocols and Ports | B | **1x** | Extended Sakai Question Pool |
| **73** | Network Devices | B | **1x** | Extended Sakai Question Pool |
| **74** | Network Devices | C | **1x** | Extended Sakai Question Pool |
| **75** | Network Devices | B | **1x** | Extended Sakai Question Pool |
| **76** | Network Devices | B | **1x** | Extended Sakai Question Pool |
| **77** | Network Devices | A | **1x** | Extended Sakai Question Pool |
| **78** | Network Devices | B | **1x** | Extended Sakai Question Pool |
| **79** | Network Devices | B | **1x** | Extended Sakai Question Pool |
| **80** | Cryptography | B | **1x** | Extended Sakai Question Pool |
| **81** | Cryptography | B | **1x** | Extended Sakai Question Pool |
| **82** | Cryptography | C | **1x** | Extended Sakai Question Pool |
| **83** | Cryptography | B | **1x** | Extended Sakai Question Pool |
| **84** | Cryptography | B | **1x** | Extended Sakai Question Pool |
| **85** | Cryptography | A | **1x** | Extended Sakai Question Pool |
| **86** | Cryptography | C | **1x** | Extended Sakai Question Pool |
| **87** | Data Classification | C | **1x** | Extended Sakai Question Pool |
| **88** | Data Classification | C | **1x** | Extended Sakai Question Pool |
| **89** | Malware | B | **1x** | Extended Sakai Question Pool |
| **90** | Malware | B | **1x** | Extended Sakai Question Pool |
| **91** | Malware | B | **1x** | Extended Sakai Question Pool |
| **92** | Malware | A | **1x** | Extended Sakai Question Pool |
| **93** | Malware | C | **1x** | Extended Sakai Question Pool |
| **94** | Social Engineering | A | **1x** | Extended Sakai Question Pool |
| **95** | Social Engineering | B | **1x** | Extended Sakai Question Pool |
| **96** | Social Engineering | A | **1x** | Extended Sakai Question Pool |
| **97** | Social Engineering | C | **1x** | Extended Sakai Question Pool |
| **98** | Business Continuity | A | **1x** | Extended Sakai Question Pool |
| **99** | Business Continuity | A | **1x** | Extended Sakai Question Pool |

---

### Quiz 1 Questions & Detailed Solutions
...
**Topic:** Internet of Things (IoT), Mobile IP Architecture, BYOD Policies, Communication Paradigms & IoT Security Regulations  
**Total Questions:** 35 (Core Exam Takes: 33, Extended Sakai Pool: 2)

### Quiz 2 Complete Answer Summary Table

| Q | Answer | Q | Answer | Q | Answer | Q | Answer | Q | Answer | Q | Answer |
|---|--------|---|--------|---|--------|---|--------|---|--------|---|--------|
| **1** | A | **7** | A | **13** | A | **19** | C | **25** | A | **31** | A |
| **2** | A | **8** | A | **14** | A | **20** | B | **26** | A | **32** | B |
| **3** | C | **9** | B | **15** | A | **21** | A | **27** | A | **33** | B |
| **4** | A | **10** | A | **16** | A | **22** | B | **28** | A | **34** | A |
| **5** | A | **11** | A | **17** | B | **23** | A | **29** | C | **35** | B |
| **6** | C | **12** | B | **18** | D | **24** | D | **30** | A |  |  |

---

### 📊 Quiz 2 Question Frequency & Repetition Analysis Table

| Q# | Question Topic / Core Concept | Answer | Repetition Count | Test Occurrences / Source Takes |
|:---|:------------------------------|:------:|:----------------:|:--------------------------------|
| **1** | Smart cities real-time traffic monitoring via IoT | A | **2x** | Main Take (Q1), Sakai Question Pool |
| **2** | IoT data and metadata ownership ambiguity | A | **2x** | Main Take (Q2), Sakai Question Pool |
| **3** | Definition of de-identified data (PII removal) | C | **2x** | Main Take (Q3), Sakai Question Pool |
| **4** | IoT metadata monetization for demographic marketing | A | **2x** | Main Take (Q4), Sakai Question Pool |
| **5** | Utility companies integrating Internet-connected sensors | A | **2x** | Main Take (Q5), Sakai Question Pool |
| **6** | Market drivers for IoT (Decline in cloud computing false) | C | **2x** | Main Take (Q6), Sakai Question Pool |
| **7** | Prompt security patching for IoT endpoint defense | A | **2x** | Main Take (Q7), Sakai Question Pool |
| **8** | IoT challenge of personal identity & privacy protection | A | **2x** | Main Take (Q8), Bayat's Quiz 2 Take (Q4), Sakai Question Pool |
| **9** | Facility automation purpose (Reduce human labor, not machinery) | B | **1x** | Main Take (Q9) |
| **10** | Key to consistent IoT environment (Interoperability & standards) | A | **2x** | Main Take (Q10), Bayat's Quiz 2 Take (Q3), Sakai Question Pool |
| **11** | Application Service Providers (ASPs) cloud hosting | A | **2x** | Main Take (Q11), Sakai Question Pool |
| **12** | Organization creating Internet/IoT standards (IETF) | B | **2x** | Main Take (Q12), Sakai Question Pool |
| **13** | Non-example of store-and-forward (Telephone call) | A | **1x** | Main Take (Q13), Bayat's Quiz 2 Take (Q5) |
| **14** | IoT software update deployment difficulty | A | **2x** | Main Take (Q14), Sakai Question Pool |
| **15** | Mobile IP Home Agent (HA) tracking & forwarding role | A | **2x** | Main Take (Q15), Sakai Question Pool |
| **16** | BYOD replacing corporate device procurement fleets | A | **2x** | Main Take (Q16), Sakai Question Pool |
| **17** | Store-and-forward suitability for immediate calls (False) | B | **2x** | Main Take (Q17), Sakai Question Pool |
| **18** | Mobile IP Correspondent Node (CN) definition | D | **2x** | Main Take (Q18), Sakai Question Pool |
| **19** | Business-to-Consumer (B2C) IoT application (Health monitoring) | C | **2x** | Main Take (Q19), Sakai Question Pool |
| **20** | Social media comments as real-time communication (False) | B | **2x** | Main Take (Q20), Sakai Question Pool |
| **21** | Vendor remote data access without active permission | A | **1x** | Main Take (Q21) |
| **22** | Policy governing employee-owned hardware (BYOD Policy) | B | **2x** | Main Take (Q22), Sakai Question Pool |
| **23** | 5G device unique IP address assignment | A | **1x** | Main Take (Q23) |
| **24** | Regulation governing healthcare IoT PHI (HIPAA) | D | **2x** | Main Take (Q24), Sakai Question Pool |
| **25** | BYOD security vulnerabilities and risk exposure | A | **2x** | Main Take (Q25), Bayat's Quiz 2 Take (Q7), Sakai Question Pool |
| **26** | Impact of IoT adoption on organizational risk (Increase) | A | **1x** | Main Take (Q26) |
| **27** | Connected vehicle ECU software update requirement | A | **2x** | Main Take (Q27), Sakai Question Pool |
| **28** | Business transformation framework for IoT (AaaS / XaaS) | A | **2x** | Main Take (Q28), Sakai Question Pool |
| **29** | Definition of Internet of Things (IoT framework) | C | **2x** | Main Take (Q29), Bayat's Quiz 2 Take (Q8), Sakai Question Pool |
| **30** | Web application security in e-business risk reduction | A | **2x** | Main Take (Q30), Sakai Question Pool |
| **31** | Mobile IP LAN segment roaming session continuity | A | **3x** | Bayat's Quiz 2 Take (Q1), Quiz 3 Take (Q73), Sakai Question Pool |
| **32** | Vendor-hosted web-accessed calendaring delivery model (SaaS) | B | **2x** | Bayat's Quiz 2 Take (Q6), Quiz 3 Take (Q74) |
| **33** | Mobile IP Foreign Agent (FA) local Care-of Address role | B | **2x** | Bayat's Quiz 2 Take (Q2), Eugene's Chat Export (Q72), Quiz 3 Take (Q72) |
| **34** | E-commerce | A | **1x** | Extended Sakai Question Pool |
| **35** | E-commerce | B | **1x** | Extended Sakai Question Pool |

---

### Quiz 2 Questions & Detailed Solutions
...
**Topic:** Comprehensive Question Bank (Data Protection, Privacy Impact Assessments, Data Sovereignty, Security Policy Framework, 7 IT Infrastructure Domains, IoT & Compliance Regulations)  
**Total Questions:** 75 (Core Exam Takes: 68, Extended Sakai Pool: 7)

### Quiz 3 Complete Answer Summary Table

| Q | Answer | Q | Answer | Q | Answer | Q | Answer | Q | Answer | Q | Answer |
|---|--------|---|--------|---|--------|---|--------|---|--------|---|--------|
| **1** | D | **14** | B | **27** | D | **40** | C | **53** | D | **66** | A |
| **2** | C | **15** | C | **28** | A | **41** | C | **54** | C | **67** | A |
| **3** | D | **16** | B | **29** | C | **42** | D | **55** | B | **68** | B |
| **4** | C | **17** | A | **30** | C | **43** | C | **56** | D | **69** | C |
| **5** | B | **18** | C | **31** | A | **44** | B | **57** | B | **70** | C |
| **6** | C | **19** | D | **32** | A | **45** | B | **58** | B | **71** | B, C |
| **7** | A | **20** | A | **33** | B | **46** | B | **59** | D | **72** | C |
| **8** | C | **21** | B | **34** | B | **47** | B | **60** | B | **73** | C |
| **9** | D | **22** | C | **35** | B | **48** | C | **61** | B | **74** | B, D |
| **10** | B | **23** | B | **36** | A | **49** | D | **62** | B | **75** | B, D |
| **11** | B | **24** | A | **37** | B | **50** | B | **63** | A |  |  |
| **12** | D | **25** | B | **38** | C | **51** | B | **64** | A |  |  |
| **13** | C | **26** | C | **39** | C | **52** | D | **65** | B |  |  |

---

### 📊 Quiz 3 Question Frequency & Repetition Analysis Table

| Q# | Question Topic / Core Concept | Answer | Repetition Count | Test Occurrences / Source Takes |
|:---|:------------------------------|:------:|:----------------:|:--------------------------------|
| **1** | Data localization vs sovereignty difference | D | **2x** | Take 1 (Q1), Eugene's Chat Export, Sakai Question Pool |
| **2** | General definition of a PIA | C | **2x** | Take 1 (Q2), Take 2 (Q7), Sakai Question Pool |
| **3** | Privacy by Design lifecycle emphasis | D | **1x** | Take 1 (Q3), Eugene's Chat Export |
| **4** | Data collection definition | C | **2x** | Take 1 (Q4), Eugene's Chat Export, Sakai Question Pool |
| **5** | Digital economy benefit of localization (AfCFTA) | B | **2x** | Take 1 (Q5), Take 2 (Q16), Eugene's Chat Export, Sakai Question Pool |
| **6** | Strict localization impact across Africa | C | **2x** | Take 1 (Q6), Sakai Question Pool |
| **7** | Requirements for DPIA under African laws (2 answers) | A | **1x** | Take 1 (Q7) |
| **8** | Mandatory DPIA laws (Ghana Act 843, NDPA, POPIA) | C | **1x** | Take 1 (Q8), Take 2 (Q6), Eugene's Chat Export |
| **9** | First step in breach response | D | **2x** | Take 1 (Q9), Sakai Question Pool |
| **10** | Security measures for records (2 answers) | B | **1x** | Take 1 (Q10) |
| **11** | Timing of DPIA execution | B | **2x** | Take 1 (Q11), Eugene's Chat Export, Sakai Question Pool |
| **12** | Application stages of Privacy by Design | D | **2x** | Take 1 (Q12), Eugene's Chat Export, Sakai Question Pool |
| **13** | Definition of data sovereignty | C | **1x** | Take 1 (Q13), Eugene's Chat Export |
| **14** | Definition of data lifecycle | B | **1x** | Take 1 (Q14), Eugene's Chat Export |
| **15** | Infrastructure & skills gap in African data hosting | C | **2x** | Take 1 (Q15), Sakai Question Pool |
| **16** | Investment driver of data localization | B | **1x** | Take 1 (Q16), Take 2 (Q19) |
| **17** | Statements defining data sovereignty (2 answers) | A | **2x** | Take 1 (Q17), Eugene's Chat Export, Sakai Question Pool |
| **18** | Essential parts of a DPIA template (2 answers) | C | **2x** | Take 1 (Q18), Eugene's Chat Export, Sakai Question Pool |
| **19** | Meaning of data localization | D | **1x** | Take 1 (Q19) |
| **20** | Frequency of reviewing a DPIA | A | **1x** | Take 1 (Q20), Take 2 (Q4), Eugene's Chat Export |
| **21** | Unique challenges to Africa's digital sovereignty (2 answers) | B | **2x** | Take 1 (Q21), Eugene's Chat Export, Sakai Question Pool |
| **22** | Opposite of Privacy by Design | C | **2x** | Take 1 (Q22), Sakai Question Pool |
| **23** | Meaning of Privacy by Design | B | **1x** | Take 1 (Q23), Take 2 (Q13), Eugene's Chat Export |
| **24** | Primary benefit of conducting a DPIA | A | **1x** | Take 1 (Q24), Take 2 (Q20), Eugene's Chat Export |
| **25** | Purpose of indexing and titling records | B | **2x** | Take 1 (Q25), Eugene's Chat Export, Sakai Question Pool |
| **26** | Control for secure record transfer | C | **2x** | Take 1 (Q26), Eugene's Chat Export, Sakai Question Pool |
| **27** | Foundation of access control (Least Privilege) | D | **2x** | Take 1 (Q27), Take 2 (Q15), Sakai Question Pool |
| **28** | Benefits of data sovereignty for Africa (2 answers) | A | **2x** | Take 1 (Q28), Take 2 (Q17), Sakai Question Pool |
| **29** | Causes of regulatory privacy fines | C | **2x** | Take 1 (Q29), Eugene's Chat Export, Sakai Question Pool |
| **30** | Quality and retention rule in records management | C | **1x** | Take 1 (Q30), Eugene's Chat Export |
| **31** | Sensitive data types requiring protection (2 answers) | A | **1x** | Take 1 (Q31) |
| **32** | Key steps in breach response (2 answers) | A | **2x** | Take 1 (Q32), Sakai Question Pool |
| **33** | Origin of DPIA (GDPR Article 35) | B | **1x** | Take 1 (Q33) |
| **34** | Distinguishing DPIA from general PIA (2 answers) | B | **1x** | Take 1 (Q34), Eugene's Chat Export |
| **35** | Entities providing regulatory enforcement power (2 answers) | B | **2x** | Take 1 (Q35), Sakai Question Pool |
| **36** | Definition of Data Protection Impact Assessment | A | **2x** | Take 1 (Q36), Sakai Question Pool |
| **37** | Benefits of DPIA in African markets (2 answers) | B | **1x** | Take 1 (Q37) |
| **38** | Regulatory control in data sovereignty | C | **1x** | Take 1 (Q38), Take 2 (Q10), Eugene's Chat Export |
| **39** | Outcomes of local data center investment (2 answers) | C | **1x** | Take 1 (Q39), Eugene's Chat Export |
| **40** | Action window for DPIA findings | C | **1x** | Take 1 (Q40), Eugene's Chat Export |
| **41** | Action for residual high risks in DPIA | C | **1x** | Take 2 (Q1), Eugene's Chat Export |
| **42** | Consequence of overly rigid localization rules | D | **2x** | Take 2 (Q2), Eugene's Chat Export, Sakai Question Pool |
| **43** | Requirement for secure destruction of records | C | **2x** | Take 2 (Q3), Sakai Question Pool |
| **44** | Core steps of the DPIA process (2 answers) | B | **1x** | Take 2 (Q5), Eugene's Chat Export |
| **45** | Consequences of omitting a DPIA (2 answers) | B | **1x** | Take 2 (Q8) |
| **46** | Risks of data localization in Africa (2 answers) | B | **2x** | Take 2 (Q9), Eugene's Chat Export, Sakai Question Pool |
| **47** | Mandatory breach notification deadline (72 hours) | B | **2x** | Take 2 (Q11), Sakai Question Pool |
| **48** | Protection target of data sovereignty | C | **2x** | Take 2 (Q12), Eugene's Chat Export, Sakai Question Pool |
| **49** | Statutory definition of POPIA | D | **1x** | Take 2 (Q18), Eugene's Chat Export |
| **50** | Uses of data in the data lifecycle (2 answers) | B | **2x** | Eugene's Chat Export, Sakai Question Pool |
| **51** | Core privacy evaluation question of a PIA | B | **2x** | Eugene's Chat Export, Sakai Question Pool |
| **52** | Purpose of a DPIA screening checklist | D | **1x** | Eugene's Chat Export |
| **53** | Communication requirements for high-risk breach notification | D | **2x** | Eugene's Chat Export, Sakai Question Pool |
| **54** | Key objective of the data lifecycle planning phase | C | **1x** | Eugene's Chat Export |
| **55** | Role of external assurance in breach response | B | **2x** | Eugene's Chat Export, Sakai Question Pool |
| **56** | Primary challenge of enforcing data localization | D | **1x** | Eugene's Chat Export |
| **57** | Core activities in the data processing phase | B | **2x** | Eugene's Chat Export, Sakai Question Pool |
| **58** | Best practices for maintaining data quality (2 answers) | B | **2x** | Eugene's Chat Export, Sakai Question Pool |
| **59** | Statutory requirement for automated processing DPIA | D | **2x** | Eugene's Chat Export, Sakai Question Pool |
| **60** | Purpose of records retention schedule | B | **1x** | Eugene's Chat Export |
| **61** | Main goal of data security during transmission | B | **1x** | Eugene's Chat Export |
| **62** | Mandatory element of data breach log | B | **1x** | Eugene's Chat Export |
| **63** | Principle of data minimization in data lifecycle | A | **1x** | Eugene's Chat Export |
| **64** | Router Access Control Lists (ACLs) | A | **1x** | Eugene's Chat Export |
| **65** | Identification vs Authentication (Username / Biometrics) | B | **1x** | Eugene's Chat Export |
| **66** | EU Compliance Obligation (GDPR) | A | **2x** | Eugene's Chat Export, Sakai Question Pool |
| **67** | Credit Card Compliance Standard (PCI DSS) | A | **1x** | Eugene's Chat Export |
| **68** | IoT Unauthorized Data Sharing to Third Parties | B | **2x** | Eugene's Chat Export, Sakai Question Pool |
| **69** | Governance & Audit | C | **1x** | Extended Sakai Question Pool |
| **70** | Digital Sovereignty | C | **1x** | Extended Sakai Question Pool |
| **71** | African Data Protection Law | B, C | **1x** | Extended Sakai Question Pool |
| **72** | Data Lifecycle | C | **1x** | Extended Sakai Question Pool |
| **73** | DPIA | C | **1x** | Extended Sakai Question Pool |
| **74** | African Data Protection Law | B, D | **1x** | Extended Sakai Question Pool |
| **75** | Records Management | B, D | **1x** | Extended Sakai Question Pool |

---

### Quiz 3 Questions & Detailed Solutions
...
**Topic:** Cryptographic Fundamentals, Active/Passive Attacks, Symmetric Block Ciphers (DES, 3DES, AES), Block Cipher Modes of Operation (ECB, CBC, CFB, CTR), Number Theory (Euler's Totient, Fermat's Little Theorem, CRT, Euclidean Algorithm), Public Key Cryptography (RSA, ElGamal, ECC, Diffie-Hellman), and CSPRNGs (BBS, TRNGs)  
**Total Questions:** 68 (Core Exam Takes: 68, Extended Sakai Pool: 0)

### Quiz 4 Complete Answer Summary Table

| Q | Answer | Q | Answer | Q | Answer | Q | Answer | Q | Answer | Q | Answer |
|---|--------|---|--------|---|--------|---|--------|---|--------|---|--------|
| **1** | C | **13** | D | **25** | A | **37** | B | **49** | D | **61** | B |
| **2** | A | **14** | transposit.. | **26** | D | **38** | A | **50** | D | **62** | B |
| **3** | Cipher | **15** | B | **27** | A | **39** | C | **51** | A | **63** | B |
| **4** | meet-in-th.. | **16** | C | **28** | D | **40** | A | **52** | B | **64** | B |
...
### 📊 Quiz 4 Question Frequency & Repetition Analysis Table

| Q# | Question Topic / Core Concept | Answer | Repetition Count | Test Occurrences / Source Takes |
|:---|:------------------------------|:------:|:----------------:|:--------------------------------|
| **1** | Complete Cryptography Basics | C | **1x** | Bayat's Take (Q1-Q68) |
| **2** | Counter (CTR) mode is popular in high-speed applications mai | A | **1x** | Quiz 4 Take |
| **3** | The ____ mode of operation converts a block cipher into a se | Cipher | **1x** | Quiz 4 Take |
| **4** | The ____ attack on double encryption reduces its effective s | meet-in-the-middle | **1x** | Quiz 4 Take |
| **5** | Fermat's Little Theorem and Euler's Theorem are foundational | RSA | **1x** | Quiz 4 Take |
| **6** | The Vigenère cipher is an example of a: | A | **1x** | Quiz 4 Take |
| **7** | An encryption scheme is said to be "computationally secure"  | D | **1x** | Quiz 4 Take |
| **8** | Which cryptanalytic technique uses linear approximations of  | A | **1x** | Quiz 4 Take |
| **9** | Fermat's Little Theorem states that if p is prime and a is n | B | **1x** | Quiz 4 Take |
| **10** | Which mode of block cipher operation encrypts blocks indepen | A | **1x** | Quiz 4 Take |
| **11** | RC4 is best described as a: | B | **1x** | Quiz 4 Take |
| **12** | Which block cipher mode turns a block cipher into a self-syn | D | **1x** | Quiz 4 Take |
| **13** | Euler's totient function phi(n) counts: | D | **1x** | Quiz 4 Take |
| **14** | A cipher in which plaintext bits or letters are rearranged w | transposition | **1x** | Quiz 4 Take |
| **15** | Which of the following best defines "computer security" as p | B | **1x** | Quiz 4 Take |
| **16** | A cipher that replaces each plaintext letter with a fixed, d | C | **1x** | Quiz 4 Take |
| **17** | The AES SubBytes transformation provides: | B | **1x** | Quiz 4 Take |
| **18** | Which statement about ECB mode is TRUE? | D | **1x** | Quiz 4 Take |
| **19** | In the Playfair cipher, when two plaintext letters fall in t | B | **1x** | Quiz 4 Take |
| **20** | Euler's totient function of a prime number p is equal to p m | A | **1x** | Quiz 4 Take |
| **21** | Compared to symmetric encryption, public-key encryption is g | D | **1x** | Quiz 4 Take |
| **22** | In the Feistel cipher structure, the function applied within | round | **1x** | Quiz 4 Take |
| **23** | The main practical drawback of the one-time pad is: | C | **1x** | Quiz 4 Take |
| **24** | In a Feistel cipher structure, encryption and decryption are | A | **1x** | Quiz 4 Take |
| **25** | DES uses a Feistel structure with 16 rounds of processing. | A | **1x** | Quiz 4 Take |
| **26** | Triple DES (3DES) with two keys typically uses which encrypt | D | **1x** | Quiz 4 Take |
| **27** | The Chinese Remainder Theorem is useful in cryptography chie | A | **1x** | Quiz 4 Take |
| **28** | Which AES transformation cyclically shifts the rows of the s | D | **1x** | Quiz 4 Take |
| **29** | The Playfair cipher encrypts: | C | **1x** | Quiz 4 Take |
| **30** | The Euclidean algorithm is used primarily to compute: | A | **1x** | Quiz 4 Take |
| **31** | The Diffie-Hellman protocol allows two parties to: | C | **1x** | Quiz 4 Take |
| **32** | A rail fence cipher is an example of a: | B | **1x** | Quiz 4 Take |
| **33** | The "model for network security" presented by Stallings assu | D | **1x** | Quiz 4 Take |
| **34** | Which of these is classified as a security mechanism rather  | A | **1x** | Quiz 4 Take |
| **35** | In the ElGamal public-key cryptosystem, security is based on | C | **1x** | Quiz 4 Take |
| **36** | Blum Blum Shub (BBS) is an example of a PRNG built on: | C | **1x** | Quiz 4 Take |
| **37** | A pseudorandom number generator (PRNG) is considered cryptog | B | **1x** | Quiz 4 Take |
| **38** | Triple DES using three independent keys effectively provides | A | **1x** | Quiz 4 Take |
| **39** | True random number generators typically derive entropy from: | C | **1x** | Quiz 4 Take |
| **40** | In modular exponentiation, the "square-and-multiply" algorit | A | **1x** | Quiz 4 Take |
| **41** | Elliptic curve cryptography (ECC) is attractive because it c | A | **1x** | Quiz 4 Take |
| **42** | What is the main weakness that makes monoalphabetic substitu | B | **1x** | Quiz 4 Take |
| **43** | Public-key cryptography, unlike symmetric cryptography, uses | B | **1x** | Quiz 4 Take |
| **44** | In the Caesar cipher, if the shift key is 3, the plaintext l | A | **1x** | Quiz 4 Take |
| **45** | A passive attack attempts to alter system resources or affec | B | **1x** | Quiz 4 Take |
| **46** | The Miller-Rabin test is used for: | A | **1x** | Quiz 4 Take |
| **47** | DES operates on plaintext blocks of: | C | **1x** | Quiz 4 Take |
| **48** | The effective key length used by DES for encryption is: | A | **1x** | Quiz 4 Take |
| **49** | In the context of security attacks, which category includes  | D | **1x** | Quiz 4 Take |
| **50** | The "period" of a pseudorandom generator refers to: | D | **1x** | Quiz 4 Take |
| **51** | A key advantage of the Feistel structure is that: | A | **1x** | Quiz 4 Take |
| **52** | A brute-force attack on an encryption algorithm involves: | B | **1x** | Quiz 4 Take |
| **53** | In block cipher design, "confusion" as described by Shannon  | A | **1x** | Quiz 4 Take |
| **54** | Cipher Block Chaining (CBC) mode XORs each plaintext block w | A | **1x** | Quiz 4 Take |
| **55** | In modular arithmetic, what is 17 mod 5? | A | **1x** | Quiz 4 Take |
| **56** | The one-time pad remains perfectly secure even if the same k | B | **1x** | Quiz 4 Take |
| **57** | The discrete logarithm problem is considered computationally | B | **1x** | Quiz 4 Take |
| **58** | In the RSA algorithm, the public key consists of: | A | **1x** | Quiz 4 Take |
| **59** | AES with a 128-bit key uses how many rounds? | B | **1x** | Quiz 4 Take |
| **60** | RSA's security is based primarily on the difficulty of compu | B | **1x** | Quiz 4 Take |
| **61** | AES supports key lengths of: | B | **1x** | Quiz 4 Take |
| **62** | Double DES is largely negated in its expected security impro | B | **1x** | Quiz 4 Take |
| **63** | AES, selected by NIST to replace DES, operates on a block si | B | **1x** | Quiz 4 Take |
| **64** | Stream ciphers, like block ciphers, always process plaintext | B | **1x** | Quiz 4 Take |
| **65** | The main criticism of DES that eventually led to its replace | B | **1x** | Quiz 4 Take |
| **66** | An initialization vector (IV) is used in most chaining modes | D | **1x** | Quiz 4 Take |
| **67** | Availability, as a security objective, means: | C | **1x** | Quiz 4 Take |
| **68** | "Diffusion" in a block cipher refers to: | A | **1x** | Quiz 4 Take |

---

### Quiz 4 Questions & Detailed Solutions
...
**Topic:** Network Security Protocols (EAP, SSH, IPsec, SSL/TLS, WEP, WPA2/802.11i), Cryptographic Hash Functions & MACs (SHA-1/2/3, HMAC, CMAC, Collision Resistance), Public Key Infrastructures (PKI, X.509, Web of Trust, PGP), and Authentication Services (Kerberos, PIV)  
**Total Questions:** 90 (Core Exam Takes: 70, Extended Sakai Pool: 20)

### Quiz 5 Complete Answer Summary Table

| Q | Answer | Q | Answer | Q | Answer | Q | Answer | Q | Answer | Q | Answer |
|---|--------|---|--------|---|--------|---|--------|---|--------|---|--------|
| **1** | D | **16** | A | **31** | A | **46** | A | **61** | C | **76** | C |
| **2** | D | **17** | A | **32** | sponge | **47** | B | **62** | D | **77** | D |
| **3** | C | **18** | B | **33** | D | **48** | D | **63** | A | **78** | C |
| **4** | C | **19** | PGP | **34** | B | **49** | B | **64** | C | **79** | Authentica.. |
| **5** | B | **20** | IPsec | **35** | B | **50** | D | **65** | B | **80** | D |
| **6** | A | **21** | A | **36** | B | **51** | B | **66** | C | **81** | Certificat.. |
| **7** | C | **22** | D | **37** | B | **52** | A | **67** | C | **82** | C |
| **8** | C | **23** | B | **38** | C | **53** | A | **68** | B | **83** | A |
| **9** | D | **24** | C | **39** | 802.1X | **54** | C | **69** | A | **84** | A |
| **10** | A | **25** | B | **40** | A | **55** | A | **70** | D | **85** | D |
| **11** | D | **26** | C | **41** | D | **56** | D | **71** | D | **86** | B |
| **12** | D | **27** | A | **42** | D | **57** | C | **72** | B | **87** | B |
| **13** | C | **28** | A | **43** | C | **58** | B | **73** | D | **88** | C |
| **14** | D | **29** | B | **44** | B | **59** | D | **74** | DSA | **89** | D |
| **15** | Authentica.. | **30** | D | **45** | C | **60** | B | **75** | A | **90** | A |

---

### 📊 Quiz 5 Question Frequency & Repetition Analysis Table

| Q# | Question Topic / Core Concept | Answer | Repetition Count | Test Occurrences / Source Takes |
|:---|:------------------------------|:------:|:----------------:|:--------------------------------|
| **1** | Full Master Set (Symmetric and Asymmetric Security) | D | **2x** | Bayat's Take (Q1-Q70), Sakai Question Pool |
| **2** | The SSH Transport Layer Protocol provides: | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **3** | IPsec operates primarily at which layer of the protocol stac | C | **2x** | Quiz 5 Take, Sakai Question Pool |
| **4** | A cryptographic hash function takes an input of arbitrary le | C | **1x** | Quiz 5 Take |
| **5** | Symmetric key distribution using a Key Distribution Center ( | B | **2x** | Quiz 5 Take, Sakai Question Pool |
| **6** | SHA-1 produces a message digest of: | A | **2x** | Quiz 5 Take, Sakai Question Pool |
| **7** | A key motivation for Kerberos is to allow a user to authenti | C | **2x** | Quiz 5 Take, Sakai Question Pool |
| **8** | A major security weakness of simple password-based remote au | C | **2x** | Quiz 5 Take, Sakai Question Pool |
| **9** | GCM (Galois/Counter Mode) achieves message authentication us | D | **1x** | Quiz 5 Take |
| **10** | DKIM allows a receiving mail server to verify that an email  | A | **1x** | Quiz 5 Take |
| **11** | The birthday attack exploits which phenomenon to find hash c | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **12** | If a digital signature private key is compromised, the most  | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **13** | Which of these is NOT typically listed among the standard ap | C | **2x** | Quiz 5 Take, Sakai Question Pool |
| **14** | The Digital Signature Algorithm (DSA), as standardized by NI | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **15** | HMAC stands for Hash-based Message ____ Code. (Fill in the b | Authentication | **2x** | Quiz 5 Take, Sakai Question Pool |
| **16** | RSA-PSS was introduced as a signature scheme mainly to addre | A | **2x** | Quiz 5 Take, Sakai Question Pool |
| **17** | A digital signature can be verified by anyone who has access | A | **2x** | Quiz 5 Take, Sakai Question Pool |
| **18** | Authenticated encryption modes such as GCM and CCM are value | B | **2x** | Quiz 5 Take, Sakai Question Pool |
| **19** | In email security, ____ uses a decentralized web-of-trust mo | PGP | **2x** | Quiz 5 Take, Sakai Question Pool |
| **20** | The protocol suite that secures IP traffic at the network la | IPsec | **1x** | Quiz 5 Take |
| **21** | The Internet Key Exchange (IKE) protocol is used within IPse | A | **2x** | Quiz 5 Take, Sakai Question Pool |
| **22** | In cloud computing terminology, "IaaS" refers to: | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **23** | Non-repudiation is a property provided by MACs but generally | B | **1x** | Quiz 5 Take |
| **24** | A Security Association (SA) in IPsec defines: | C | **1x** | Quiz 5 Take |
| **25** | Kerberos tickets typically include a timestamp and lifetime  | B | **1x** | Quiz 5 Take |
| **26** | ECDSA differs from standard DSA mainly in that it: | C | **1x** | Quiz 5 Take |
| **27** | The TLS Handshake Protocol allows the client and server to n | A | **2x** | Quiz 5 Take, Sakai Question Pool |
| **28** | In wireless network security, the four-way handshake in 802. | A | **2x** | Quiz 5 Take, Sakai Question Pool |
| **29** | Pretty Good Privacy (PGP) provides email security services i | B | **1x** | Quiz 5 Take |
| **30** | IPsec's tunnel mode, compared to transport mode, differs in  | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **31** | Downgrade attacks against SSL/TLS attempt to: | A | **1x** | Quiz 5 Take |
| **32** | The ____ construction underlies SHA-3 (Keccak), absorbing in | sponge | **2x** | Quiz 5 Take, Sakai Question Pool |
| **33** | PGP uses which approach for key management, rather than rely | D | **1x** | Quiz 5 Take |
| **34** | The Schnorr digital signature scheme is notable for: | B | **2x** | Quiz 5 Take, Sakai Question Pool |
| **35** | WEP's main cryptographic weakness stemmed from: | B | **2x** | Quiz 5 Take, Sakai Question Pool |
| **36** | IPsec's ESP in transport mode encrypts the entire original I | B | **2x** | Quiz 5 Take, Sakai Question Pool |
| **37** | Kerberos relies exclusively on public-key cryptography and d | B | **1x** | Quiz 5 Take |
| **38** | S/MIME extends standard email primarily to add: | C | **2x** | Quiz 5 Take, Sakai Question Pool |
| **39** | IEEE ____ defines the standard for port-based network access | 802.1X | **1x** | Quiz 5 Take |
| **40** | Secure Shell (SSH) is primarily used for: | A | **2x** | Quiz 5 Take, Sakai Question Pool |
| **41** | DomainKeys Identified Mail (DKIM) is designed mainly to: | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **42** | SHA-3 (Keccak) differs structurally from SHA-2 in that it is | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **43** | CMAC is a MAC algorithm based on: | C | **2x** | Quiz 5 Take, Sakai Question Pool |
| **44** | A major security concern specific to multi-tenant cloud envi | B | **2x** | Quiz 5 Take, Sakai Question Pool |
| **45** | TLS improves on earlier SSL versions partly through the use  | C | **2x** | Quiz 5 Take, Sakai Question Pool |
| **46** | SHA-3 is based on the Keccak sponge construction. | A | **2x** | Quiz 5 Take, Sakai Question Pool |
| **47** | Key distribution using asymmetric encryption can be used to  | B | **2x** | Quiz 5 Take, Sakai Question Pool |
| **48** | SSL/TLS operates primarily at which layer to secure applicat | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **49** | The property that it should be computationally infeasible to | B | **1x** | Quiz 5 Take |
| **50** | To resist birthday attacks effectively, a hash function's ou | D | **1x** | Quiz 5 Take |
| **51** | HMAC constructs a MAC by combining a hash function with: | B | **1x** | Quiz 5 Take |
| **52** | Cipher block chaining can be adapted to build a simple hash  | A | **2x** | Quiz 5 Take, Sakai Question Pool |
| **53** | The X.509 standard defines the format for: | A | **2x** | Quiz 5 Take, Sakai Question Pool |
| **54** | A digital signature scheme primarily provides: | C | **2x** | Quiz 5 Take, Sakai Question Pool |
| **55** | A certificate revocation list (CRL) is used to: | A | **2x** | Quiz 5 Take, Sakai Question Pool |
| **56** | In key wrapping, the primary goal is to: | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **57** | Public-key certificates chiefly solve which key distribution | C | **2x** | Quiz 5 Take, Sakai Question Pool |
| **58** | Which of the following best describes CCM mode? | B | **2x** | Quiz 5 Take, Sakai Question Pool |
| **59** | Which of the following is a common basis for user authentica | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **60** | The security of HMAC depends most directly on the properties | B | **2x** | Quiz 5 Take, Sakai Question Pool |
| **61** | In a hierarchical PKI trust model, trust ultimately derives  | C | **1x** | Quiz 5 Take |
| **62** | Mobile device security concerns highlighted by Stallings inc | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **63** | Personal Identity Verification (PIV), as standardized by NIS | A | **2x** | Quiz 5 Take, Sakai Question Pool |
| **64** | A Message Authentication Code (MAC) differs from a plain has | C | **2x** | Quiz 5 Take, Sakai Question Pool |
| **65** | IEEE 802.1X provides port-based network access control prima | B | **2x** | Quiz 5 Take, Sakai Question Pool |
| **66** | Remote user authentication using asymmetric encryption can r | C | **2x** | Quiz 5 Take, Sakai Question Pool |
| **67** | The SHA-2 family of hash functions includes variants such as | C | **1x** | Quiz 5 Take |
| **68** | A "chain of trust" in PKI refers to: | B | **1x** | Quiz 5 Take |
| **69** | A key requirement for MACs, distinguishing them from ordinar | A | **1x** | Quiz 5 Take |
| **70** | Kerberos is best described as: | D | **2x** | Quiz 5 Take, Sakai Question Pool |
| **71** | Digital Signatures | D | **1x** | Extended Sakai Question Pool |
| **72** | HMAC | B | **1x** | Extended Sakai Question Pool |
| **73** | TLS/HTTPS | D | **1x** | Extended Sakai Question Pool |
| **74** | Digital Signatures | DSA | **1x** | Extended Sakai Question Pool |
| **75** | PKI | A | **1x** | Extended Sakai Question Pool |
| **76** | PKI | C | **1x** | Extended Sakai Question Pool |
| **77** | TLS | D | **1x** | Extended Sakai Question Pool |
| **78** | Kerberos | C | **1x** | Extended Sakai Question Pool |
| **79** | Kerberos | Authenticati | **1x** | Extended Sakai Question Pool |
| **80** | Hash Functions | D | **1x** | Extended Sakai Question Pool |
| **81** | PKI | Certificate  | **1x** | Extended Sakai Question Pool |
| **82** | Key Distribution | C | **1x** | Extended Sakai Question Pool |
| **83** | TLS | A | **1x** | Extended Sakai Question Pool |
| **84** | Email Security | A | **1x** | Extended Sakai Question Pool |
| **85** | Authentication | D | **1x** | Extended Sakai Question Pool |
| **86** | PKI | B | **1x** | Extended Sakai Question Pool |
| **87** | MAC | B | **1x** | Extended Sakai Question Pool |
| **88** | Identity Management | C | **1x** | Extended Sakai Question Pool |
| **89** | Wireless Security | D | **1x** | Extended Sakai Question Pool |
| **90** | Digital Signatures | A | **1x** | Extended Sakai Question Pool |

---

### Quiz 5 Questions & Detailed Solutions
